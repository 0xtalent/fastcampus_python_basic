...
conn = sqlite3.connect(
    'C:/python_basic/resource/database.db', isolation_level=None)
...
# 데이터 삽입
c.execute("INSERT INTO users VALUES (1 ,'Jung','superhayong@naver.com', '010-0000-0000', 'Jung.com', ?)", (nowDatetime,))
